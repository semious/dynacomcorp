...
$(document).ready(function(){
	$('#navigator a').eq(6).css('color','#CC0000');
	$('#navigator a').eq(6).css('cursor','default');
				...
				<div id="contact_info">
					<ul>
						<li>
							...
							31082 San Antonio Street<br />
							Hayward, CA 94544<br />
							Tel:510-441-7800<br />
							Fax:510-441-1676<br />
							Email:<a href="mailto:sales@dynacomcorp.com">sales@dynacomcorp.com</a>
						</li>
